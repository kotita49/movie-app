...
const requestGenres = axios.get(`https://api.themoviedb.org/3/genre/movie/list?api_key=${API_KEY}&language=en`)
...
componentDidMount(){
  //api call
axios.all([requestPopular, requestGenres]).then(axios.spread((...responses)=>{
  ...
  this.setState({results: popularFilms, totalCount: popularFilms.length, genreOptions: genres})
})
...
// .then(resp => {
//   const resultFilms = resp.results;
//   this.setState({results: resultFilms, totalCount: resultFilms.length})
// })
